...
python train.py data/admin_cfg.json -u data/user_cfg.json --model=se_res_bilrcn --crop-size=20 --seq-len=6 --batch-size=128 --epoch=150 --input_past_interval=30 --real -lr=0.1
