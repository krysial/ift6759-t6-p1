...
python train.py data/admin_cfg.json -u data/user_cfg.json --model=convlstm  --input_past_interval=30 --crop-size=40 --seq-len=6 --batch-size=32 --epoch=150 --real -lr=0.1
