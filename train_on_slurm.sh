...
python train.py data/admin_cfg.json -u data/user_cfg.json --model=se_res_bilrcn --crop-size=80 --seq-len=12 --batch-size=48 --epoch=150 --input_past_interval=30 --real
